...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| 新規作成 | Web | 両方 | x | x | o | o | [U:EditorToolbar](../../packages/editor-core/src/__tests__/EditorToolbar.test.tsx) | 2026-03-15 | [E:file-ops](../../packages/web-app/e2e/file-ops.spec.ts) |  | SP はファイルメニュー経由。VS は VSCode ネイティブ |
| ファイルを開く | Web | 両方 | o | o | o | o | [U:EditorToolbar](../../packages/editor-core/src/__tests__/EditorToolbar.test.tsx) | 2026-03-15 | [E:file-ops](../../packages/web-app/e2e/file-ops.spec.ts) |  | VS は VSCode ネイティブ |
...
| 名前を付けて保存 | Web | 両方 | o | o | o | o | [U:EditorToolbar](../../packages/editor-core/src/__tests__/EditorToolbar.test.tsx) | 2026-03-15 | [E:file-ops](../../packages/web-app/e2e/file-ops.spec.ts) |  | VS は VSCode ネイティブ |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| テキスト入力・編集 | 全 | 両方 | x | x | o | o | - |  | [E:editor-basic](../../packages/web-app/e2e/editor-basic.spec.ts) |  | `editor.setEditable()` で制御 |
| 元に戻す / やり直し | 全 | 両方 | x | x | o | o | - |  | [E:keyboard](../../packages/web-app/e2e/keyboard.spec.ts) |  | VS は VSCode ネイティブ。比較時は `mergeUndoRedo` に切替 |
...
| スラッシュコマンド | 全 | 両方 | x | x | o | o | - |  | [E:toolbar](../../packages/web-app/e2e/toolbar.spec.ts) |  | `editable` 状態に依存 |
| 検索・置換 | 全 | 両方 | o | o | o | o | - |  | [E:search-replace](../../packages/web-app/e2e/search-replace.spec.ts) |  | Ctrl+F で検索、Ctrl+H で置換。大文字小文字区別・単語単位・正規表現対応 |
...
| 太字・斜体・下線・取消線等 | 全 | 両方 | x | x | o | x | - |  | [E:keyboard](../../packages/web-app/e2e/keyboard.spec.ts), [E:text-formatting](../../packages/web-app/e2e/text-formatting.spec.ts) |  | 下線は Ctrl+U |
| ハイライト（蛍光マーカー） | 全 | 両方 | x | x | o | x | - |  | [E:text-formatting](../../packages/web-app/e2e/text-formatting.spec.ts) |  | Ctrl+Shift+H |
| インラインコード | 全 | 両方 | x | x | o | x | - |  | [E:text-formatting](../../packages/web-app/e2e/text-formatting.spec.ts) |  | Ctrl+E |
| リンク挿入 | 全 | 両方 | x | x | o | x | - |  | [E:text-formatting](../../packages/web-app/e2e/text-formatting.spec.ts) |  | |
| コメント追加 | 全 | 両方 | x | o | o | x | - |  | [E:comment](../../packages/web-app/e2e/comment.spec.ts) |  | Review は `executeInReviewMode` 経由 |
| チェックボックス操作 | 全 | 両方 | x | o | o | x | - |  | [E:text-formatting](../../packages/web-app/e2e/text-formatting.spec.ts) |  | Readonly は CSS `pointer-events: none` |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| 見出し（H1〜H5） | 全 | 両方 | x | x | o | x | - |  | [E:toolbar](../../packages/web-app/e2e/toolbar.spec.ts) |  | 折りたたみ・自動番号付き |
| 箇条書きリスト | 全 | 両方 | x | x | o | x | - |  | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) |  | ネスト対応 |
| 番号付きリスト | 全 | 両方 | x | x | o | x | - |  | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) |  | ネスト対応 |
| タスクリスト | 全 | 両方 | x | x | o | x | - |  | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) |  | チェックボックス付き |
| 引用（Blockquote） | 全 | 両方 | x | x | o | x | - |  | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) |  | |
...
| 水平線 | 全 | 両方 | x | x | o | x | - |  | [E:toolbar](../../packages/web-app/e2e/toolbar.spec.ts) |  | |
| 脚注 | 全 | 両方 | x | x | o | x | [U:footnote](../../packages/editor-core/src/__tests__/footnote.test.ts) | 2026-03-15 | - |  | `[^id]` 記法 |
| 日付挿入 | 全 | 両方 | x | x | o | x | - |  | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) |  | `/date` で YYYY-MM-DD 形式の今日の日付を挿入 |
...
| Details / Summary | 全 | 両方 | x | x | o | x | [E:markdown-elements](../../packages/web-app/e2e/markdown-elements.spec.ts) | | 折りたたみ可能ブロック |
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- | --- |
| ブロック挿入 | 全 | 両方 | x | x | o | x | 全ブロック | - |  | [E:toolbar](../../packages/web-app/e2e/toolbar.spec.ts) |  | スラッシュコマンド経由 |
...
| ブロック削除 | 全 | 両方 | x | x | o | x | 全ブロック | - |  | [E:block-elements](../../packages/web-app/e2e/block-elements.spec.ts) |  | |
...
| ダブルクリック編集 | 全 | 両方 | o | o | o | x | ダイアグラム / 数式 / HTML | - |  | [E:block-elements](../../packages/web-app/e2e/block-elements.spec.ts) |  | ダブルクリックでプレビューからブロック要素編集画面を開く |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| 全折りたたみ / 全展開 | 全 | 通常 | x | x | o | x | - |  | [E:outline](../../packages/web-app/e2e/outline.spec.ts) |  | パネル上部のアイコンで操作 |
| 個別折りたたみ切替 | 全 | 通常 | x | x | o | x | [U:useOutline](../../packages/editor-core/src/__tests__/useOutline.test.ts) | 2026-03-15 | - |  | 見出し行の矢印アイコンで切替 |
| 見出しクリックナビゲーション | 全 | 通常 | o | o | o | x | - |  | [E:outline](../../packages/web-app/e2e/outline.spec.ts) |  | クリックでエディタ内の該当位置へスクロール |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| コメント追加（テキスト選択） | 全 | 両方 | x | o | o | x | [U:comment](../../packages/editor-core/src/__tests__/comment.test.ts) | 2026-03-15 | [E:comment](../../packages/web-app/e2e/comment.spec.ts) |  | Ctrl+Shift+M またはバブルメニュー。選択テキストは黄色背景でハイライト |
...
| コメントパネル表示 | 全 | 両方 | o | o | o | x | - |  | [E:comment](../../packages/web-app/e2e/comment.spec.ts) |  | ツールバーのコメントアイコンで開閉 |
...
| フォントサイズ | 全 | 両方 | o | o | o | o | [U:useEditorSettings](../../packages/editor-core/src/__tests__/useEditorSettings.test.ts), [U:EditorSettingsPanel](../../packages/editor-core/src/__tests__/EditorSettingsPanel.test.tsx) | 2026-03-15 | [E:settings](../../packages/web-app/e2e/settings.spec.ts) |  | |
...
| 機能 | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| 通常 / 比較 切替 | PC/VS | 両方 | x | o | o | o | [U:useMergeMode](../../packages/editor-core/src/__tests__/useMergeMode.test.ts) | 2026-03-15 | [E:compare-mode](../../packages/web-app/e2e/compare-mode.spec.ts) |  | VS はコマンド経由でも可 |
...
| アウトラインパネル | 全 | 通常 | o | o | o | x | - |  | [E:outline](../../packages/web-app/e2e/outline.spec.ts) |  | SP はモバイルメニュー経由。VS は VSCode サイドバー |
| コメントパネル | 全 | 両方 | o | o | o | x | - |  | [E:comment](../../packages/web-app/e2e/comment.spec.ts) |  | SP はモバイルメニュー経由。VS は VSCode サイドバー |

#### モードアイコン

| アイコン | 対応 | 比較 | Readonly | Review | WYSIWYG | Source | UT | UT確認日 | E2E | E2E確認日 | 備考 |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | --- | --- | --- | --- | --- |
| モード切替 | 全 | 両方 | o | o | o | o | - |  | [E:mode-switch](../../packages/web-app/e2e/mode-switch.spec.ts) |  | pill 型トグル。常に操作可。SP ではラベル非表示（アイコンのみ） |
| 通常 / 比較 切替 | PC/VS | 両方 | x | o | o | o | - |  | [E:compare-mode](../../packages/web-app/e2e/compare-mode.spec.ts) |  | SP はモバイルメニューに非表示 |
