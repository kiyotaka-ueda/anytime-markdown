...
**Git repository management, staging, graph, and timeline for VS Code.**

Manage Git repositories, stage and commit changes, visualize commit history, and browse file timelines — all from a dedicated sidebar panel.
